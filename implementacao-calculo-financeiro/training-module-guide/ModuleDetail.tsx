...
import { DiagramEditor } from '@/components/training/DiagramEditor';
...
export function ModuleDetail({ module, onBack, onVideoSelect }: ModuleDetailProps) {
  ...
  const getEstimatedDuration = (): string => {
    const totalSeconds = module.videos.reduce((sum, video) => sum + (video.duration_seconds || 0), 0);
        ...
        <CardContent className="p-4">
          <div className="space-y-2">
            ...
            <div className="flex justify-between text-xs text-gray-600">
              <span>{completedVideos}/{module.videos.length} vídeos assistidos</span>
            ...
            <Card>
              <CardContent className="p-4">
                <div className="flex items-center space-x-2">
                  ...
                  <div>
                    <div className="text-2xl font-bold">{module.playbooks.length}</div>
            ...
            <Card>
              <CardContent className="p-4">
                <div className="flex items-center space-x-2">
                  ...
                  <div>
                    <div className="text-2xl font-bold">{module.diagrams.length}</div>
            ...
            <Card>
              <CardContent className="p-4">
                <div className="flex items-center space-x-2">
                  ...
                  <div>
                    <div className="text-2xl font-bold">{module.assessments.length}</div>
            ...
            <Card>
              <CardContent className="p-8 text-center">
                ...
                <div className="text-sm text-gray-500">
                  Progresso: {completedVideos}/{module.videos.length} vídeos assistidos
                </div>
              </CardContent>
            </Card>
          ) : showAssessment ? (
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                ...
                <div className="grid grid-cols-2 gap-4 text-sm">
                  <div>
                    <span className="font-medium">Questões:</span> {module.assessments[0].questions.length}
                  </div>
                  <div>
                    <span className="font-medium">Pontuação mínima:</span> {module.assessments[0].passing_score}%
                  </div>
