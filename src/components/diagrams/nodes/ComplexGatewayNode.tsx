...
interface ComplexGatewayNodeProps {
  data: {
    label?: string;
    isSelected?: boolean;
  };
...
export const ComplexGatewayNode: React.FC<ComplexGatewayNodeProps> = ({ data, selected }) => {
  return (
    <div
      className={cn(
    ...
    >
      ...
      <div className="flex items-center justify-center mb-1">
        <Asterisk className="w-6 h-6 text-red-600" />
      </div>
...
export default ComplexGatewayNode;